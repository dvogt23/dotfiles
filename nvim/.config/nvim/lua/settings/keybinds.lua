...
map("n", "<leader>la", ":lua vim.lsp.buf.code_action()<CR>") -- TODO
map("v", "<leader>la", ":lua lua vim.lsp.buf.range_code_action()<CR>") -- TODO
map("n", "<leader>lf", ":lua vim.lsp.buf.formatting()<CR>", {}) -- TODO
map("v", "<leader>lf", ":lua vim.lsp.buf.range_formatting()") -- TODO
map('n', '<leader>lrn', '<cmd>lua vim.lsp.buf.rename()<CR>', opts)
...
map('n', '<leader>ld', '<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>', opts)
...
-- Git
map("n", "<leader>gha", "<Plug>(GitGutterStageHunk)")
map("n", "<leader>ghr", "<Plug>(GitGutterUndoHunk)")
map("n", "<leader>ghd", "<Plug>(GitGutterPreviewHunk)")
map("n", "<leader>gs", "<Plug>(GitGutterPreviewHunk)")
map("n", "<leader>gb", "<Plug>(GitGutterPreviewHunk)")
map("n", "<leader>gl", "<Plug>(GitGutterPreviewHunk)")
map("n", "<leader>glf", "<Plug>(GitGutterPreviewHunk)")
