...
map("v", "<leader>sa", ":RangeCodeActions<CR>")
...
map("n", "<leader>ghn", ":lua require'gitsigns'.next_hunk()<CR>")
map("n", "<leader>ghp", ":lua require'gitsigns'.prev_hunk()<CR>")
map("n", "<leader>gs", ":Gstatus<CR>")
map("n", "<leader>gb", ":Gitsigns toggle_current_line_blame<CR>", opts)
map("n", "<leader>gbb", ":Git blame<CR>", opts)
